...
export async function provisionSprite(
  ...
  logger.info(
    { sprite: spriteName },
    'Provisioning Sprite (first-time setup)...',
  );
  ...
  await sprite.exec(
    'mkdir -p /workspace/group /workspace/global /workspace/ipc/messages /workspace/ipc/tasks /workspace/ipc/input /workspace/env-dir /workspace/shared',
  );
