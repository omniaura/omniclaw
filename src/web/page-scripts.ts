...
function ipcScript(): string {
  return [
    ...
    '      var mrTitle=(window.__laneReasonDesc&&window.__laneReasonDesc[mr])?" title=\\""+window.__esc(window.__laneReasonDesc[mr])+"\\"":"";',
    '      var trTitle=(window.__laneReasonDesc&&window.__laneReasonDesc[tr])?" title=\\""+window.__esc(window.__laneReasonDesc[tr])+"\\"":"";',
    '      var mrSpan=mr?"<span class=\\"lane-reason reason-"+window.__esc(mr)+"\\""+mrTitle+">"+window.__esc(mr)+"</span>":"";',
    '      var trSpan=tr?"<span class=\\"lane-reason reason-"+window.__esc(tr)+"\\""+trTitle+">"+window.__esc(tr)+"</span>":"";',
...
function agentDetailScript(): string {
  return [
    ...
    '  if(showReason){',
    '    var rTitle=(window.__laneReasonDesc&&window.__laneReasonDesc[reason])?" title=\\""+escapeHtml(window.__laneReasonDesc[reason])+"\\"":"";',
    '    inner+="<span class=\\"lane-reason reason-"+reason+"\\" data-exec-reason=\\""+reason+"\\""+rTitle+">"+escapeHtml(reason)+"</span>";',
    '  }',
