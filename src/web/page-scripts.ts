...
function networkScript(): string {
  return [
    ...
    '        +\'<button class="btn btn-sm btn-primary" onclick="networkAction(\\\'approve\\\',\\\'\'+r.id+\'\\\')">Approve</button>\'',
    '        +\'<button class="btn btn-sm btn-danger" onclick="networkAction(\\\'reject\\\',\\\'\'+r.id+\'\\\')">Reject</button>\'',
    '        +\'</div></div>\';',
    '    }).join("");',
    '  }).catch(function(){});',
    '}',
    ...
    '    +\'<div style="display:flex;gap:0.5rem">\'',
    '    +\'<button class="btn btn-sm" onclick="closeSyncPanel()">Close</button>\'',
    '    +\'<button class="btn btn-sm" onclick="openSyncPanel(\\\'\'+instanceId+\'\\\')">Refresh</button>\'',
    '    +\'</div></div>\';',
    '',
    '  // Stats bar',
    ...
    '        +\'<td><button class="btn btn-sm" onclick="networkAction(\\\'push\\\',\\\'\'+instanceId+\'|\'+d.local.path+\'\\\')">Push \\u2192</button> \'',
    '        +\'<button class="btn btn-sm" onclick="networkAction(\\\'pull\\\',\\\'\'+instanceId+\'|\'+d.local.path+\'\\\')">\\u2190 Pull</button></td></tr>\';',
    '    });',
    '',
    '    // Local only',
    ...
    '        +\'<td>\'+fmtBytes(f.size)+\'</td>\'',
    '        +\'<td>\\u2014</td>\'',
    '        +\'<td><button class="btn btn-sm" onclick="networkAction(\\\'push\\\',\\\'\'+instanceId+\'|\'+f.path+\'\\\')">Push \\u2192</button></td></tr>\';',
    '    });',
    '',
    '    // Remote only',
    ...
    '        +\'<td>\\u2014</td>\'',
    '        +\'<td>\'+fmtBytes(f.size)+\'</td>\'',
    '        +\'<td><button class="btn btn-sm" onclick="networkAction(\\\'pull\\\',\\\'\'+instanceId+\'|\'+f.path+\'\\\')">\\u2190 Pull</button></td></tr>\';',
    '    });',
    '',
    '    h+=\'</tbody></table>\';',
    '',
    ...
    '      if(pushable>0)h+=\'<button class="btn btn-sm btn-primary" onclick="bulkSync(\\\'push\\\',\\\'\'+instanceId+\'\\\')">Push All (\'+pushable+\') \\u2192</button>\';',
    '      if(pullable>0)h+=\'<button class="btn btn-sm" onclick="bulkSync(\\\'pull\\\',\\\'\'+instanceId+\'\\\')">\\u2190 Pull All (\'+pullable+\')</button>\';',
    '      h+=\'</div>\';',
    '    }',
    '  }',
    '',
    ...
    '',
    'pollTimer=setInterval(function(){refreshPeers();refreshRequests();},10000);',
    '',
