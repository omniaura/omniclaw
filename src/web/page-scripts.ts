...
function conversationsScript(): string {
  return [
    ...
    'if(!chatList)return;',
    'var currentJid=null;var messageCache={};var PAGE_SIZE=100;var searchMode=false;var searchTimer=null;',
    '',
    // Tab switching
    ...
    '  history.replaceState(null,"","/conversations?q="+encodeURIComponent(query));',
    ...
    '  }).catch(function(){searchResultsEl.innerHTML=\'<div class="search-count">search failed</div>\';});',
    '}',
    '',
    ...
    '    var text=r.content||"";var snippet=text.length>120?text.slice(0,117)+"\\u2026":text;',
    '    var time=new Date(r.timestamp).toLocaleString();',
    '    h+=\'<div class="search-result" data-jid="\'+window.__esc(r.chat_jid)+\'">\';',
