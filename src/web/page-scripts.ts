...
function systemScript(): string {
  return [
    ...
    '      if(el)el.textContent=h.queue.running_tasks>0?(h.queue.longest_running_task_group?fmtDur(h.queue.longest_running_task_ms)+" \u00b7 "+h.queue.longest_running_task_group:fmtDur(h.queue.longest_running_task_ms)):"\u2014";',
    '      el=document.getElementById("sys-queue-longest-running-message");',
    '      if(el)el.textContent=h.queue.processing_groups>0?(h.queue.longest_running_message_group?fmtDur(h.queue.longest_running_message_ms)+" \u00b7 "+h.queue.longest_running_message_group:fmtDur(h.queue.longest_running_message_ms)):"\u2014";',
