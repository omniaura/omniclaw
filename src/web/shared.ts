...
function shellCSS(): string {
  return [
    ...
    `.task-outcome{margin-top:3px}`,
    `.outcome-done{background:rgba(52,211,153,.1);color:var(--green)}`,
    `.outcome-blocked{background:rgba(248,113,113,.1);color:var(--red)}`,
    `.outcome-abandoned{background:rgba(99,106,126,.12);color:var(--text-dim)}`,
    `.outcome-skipped{background:rgba(251,191,36,.1);color:var(--yellow)}`,
    `.outcome-unknown{background:rgba(99,106,126,.12);color:var(--text-dim)}`,
    ...
    `.last-error{font-size:11px;max-width:320px}`,
    `.last-error-link{display:inline-flex;align-items:baseline;gap:6px;color:var(--red);text-decoration:none;max-width:100%}`,
