...
function shellCSS(): string {
  return [
    ...
    `.tasks-search{margin-top:6px}`,
    `.tasks-search-input{width:100%;padding:4px 8px;background:var(--bg);border:1px solid var(--border);border-radius:4px;color:var(--text);font-family:var(--mono);font-size:11px}`,
    `.tasks-search-input:focus{outline:none;border-color:var(--accent)}`,
