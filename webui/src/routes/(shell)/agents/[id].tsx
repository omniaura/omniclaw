  ...
  return (
    <>
      ...
      <div class="p-4 max-w-4xl mx-auto">
        ...
        <ErrorBoundary
          fallback={(err, reset) => (
            <ErrorFallback error={err} reset={reset} context="Agent Detail" />
          )}
        >
          <Suspense fallback={<PageLoading label="Loading agent..." />}>
            <Show
              when={agent()}
              fallback={
                <div class="text-text-dim">
                  <p>
                    Agent not found:{' '}
                    <code class="text-accent">{params.id}</code>
                  </p>
