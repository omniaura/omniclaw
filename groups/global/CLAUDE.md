...
If you need information from outside your workspace (files from another project, context from another group, credentials, etc.), use `mcp__nanoclaw__share_request`. This sends a request to the admin, who can review and share the relevant context with you. Don't guess — ask.
