...
**Attentive follow-up** (one-shot): after an agent is triggered by an explicit mention, it stays "attentive" for the *next* incoming message without needing a trigger. This is for human follow-ups, not for bot loops.
